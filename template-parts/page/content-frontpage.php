...
<section id="what-is-advicer">
  <div class="container">
    <div class="row">
      <div class="col-xl-8 offset-xl-2 col-12 text-center">
        <h2 class="section-title">What is Advicer?</h2>
        <p class="excerpt mb-5">
          In Advicer, you can guide people by sharing your good or bad advice instantly for a product, business,
          house, car, property, company, hotel, restaurant, food, doctor, engineer, or you can save yourself from a
          possible bad result by taking advantage of the advice given.
        </p>
      </div>
...
<section id="features">
  <div class="container">
    <div class="row">
      <div class="col-xl-8 col-12 text-center offset-xl-2">
        <h2 class="section-title">
          A platform designed for <span>trust</span>
        </h2>
        <p class="excerpt">
          Would you like to have more detailed information about the person you are considering to collaborate with or
          hire for a new job? Would you like to learn the answers to many more questions from their closest ones?
        </p>
      </div>
      <div class="col-12">
...
<section id="how-advicer-works" class="section-margin">
  <div class="container">
    <div class="row">
      <div class="col-xl-8 col-12">
        <h2 class="section-title">How Advicer Works?</h2>
        <p class="excerpt">
          Advicer is a user-friendly platform designed to facilitate efficient knowledge sharing and
